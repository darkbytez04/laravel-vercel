...
<div class="bot">
    <div id="table">
     ...
     <div class="legalcopy">
         <p class="legal"> <strong>** Thank you for shopping **
         </strong> <br>
        The goods which are subj to tax, prices include </p>
     </div>
     <div class="serial-number"> 
         Serial: <span class="serial">
            1223241214
         </span>
         <span> 24/12/2022 &nbsp; &nbsp; 00:45</span>
     </div>
    </div>
</div>
